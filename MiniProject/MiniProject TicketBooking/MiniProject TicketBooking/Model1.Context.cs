...
namespace MiniProject_TicketBooking
{
    ...
    public partial class MiniProjectTicketBookingEntities : DbContext
    {
        public MiniProjectTicketBookingEntities()
            : base("name=MiniProjectTicketBookingEntities")
        {
        }
        ...
        public virtual int AddTrain(Nullable<int> trainId, string @class, string trainName, string fromStation, string toStation, string trainManagerName, Nullable<int> totalBerths, Nullable<int> availableBerths, Nullable<decimal> fare, Nullable<bool> isActive)
        {
            var trainIdParameter = trainId.HasValue ?
                new ObjectParameter("TrainId", trainId) :
                new ObjectParameter("TrainId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddTrain", trainIdParameter, classParameter, trainNameParameter, fromStationParameter, toStationParameter, trainManagerNameParameter, totalBerthsParameter, availableBerthsParameter, fareParameter, isActiveParameter);
        }
    
        public virtual int BookTicket(string loginId, string password, Nullable<int> trainId, string @class, string passengerName, Nullable<int> seatsBooked, Nullable<System.DateTime> bookingDate, Nullable<System.DateTime> dateOfTravel, ObjectParameter amount, ObjectParameter bookingId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BookTicket", loginIdParameter, passwordParameter, trainIdParameter, classParameter, passengerNameParameter, seatsBookedParameter, bookingDateParameter, dateOfTravelParameter, amount, bookingId);
        }
        ...
        public virtual int UpdateTrainDetails(Nullable<int> trainId, string @class, string trainName, string fromStation, string toStation, string trainManagerName, Nullable<int> totalBerths, Nullable<int> availableBerths, Nullable<decimal> fare, Nullable<bool> isActive)
        {
            var trainIdParameter = trainId.HasValue ?
                new ObjectParameter("TrainId", trainId) :
                new ObjectParameter("TrainId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTrainDetails", trainIdParameter, classParameter, trainNameParameter, fromStationParameter, toStationParameter, trainManagerNameParameter, totalBerthsParameter, availableBerthsParameter, fareParameter, isActiveParameter);
        }
