...
namespace ETradingSystem.Models
{
    ...
    public partial class E_TradingDBEntities2 : DbContext
    {
        public E_TradingDBEntities2()
            : base("name=E_TradingDBEntities2")
        {
        }
        ...
        public virtual int InsertBucketListItem(Nullable<int> product_Id, Nullable<int> customer_Id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertBucketListItem", product_IdParameter, customer_IdParameter);
        }
        ...
        internal void PlaceOrder(int product_Id, int quantity, DateTime delivery_Date, string payment_Mode, string address)
        {
